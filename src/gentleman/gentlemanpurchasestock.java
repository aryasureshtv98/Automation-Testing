...
public class gentlemanpurchasestock {

	ChromeDriver driver;
	public  gentlemanpurchasestock (ChromeDriver maindriver)
	{
		this.driver = maindriver;
	}
	@Test
	public void tstps () throws InterruptedException
	{
		Actions act = new Actions(driver);
		driver.findElement(By.xpath("//*[@id=\"navi\"]/li[12]/a")).click();
		Thread.sleep(1500);
		...
		act.moveToElement(search).click().sendKeys("AUCTION DIFFERENCE FORM");
		Thread.sleep(1500);
